...
<script type="text/javascript">
	$(document).ready(function(){  
		...
		$('.popcorn1').click(function(){
			...
			$('.popcorn1').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
		...
		$('.popcorn2').click(function(){
			...
			$('.popcorn1').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn2').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn3').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.popcorn4').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.popcorn5').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.pop_point').val(2);
		...
		$('.popcorn3').click(function(){
			...
			$('.popcorn1').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn2').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn3').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn4').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.popcorn5').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.pop_point').val(3);
		});
		$('.popcorn4').click(function(){
			...
			$('.popcorn2').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn3').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn4').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn5').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_gray.png");
			$('.pop_point').val(4);
		});
		$('.popcorn5').click(function(){
			...
			$('.popcorn3').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn4').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.popcorn5').attr("src","<%=request.getContextPath() %>/Resources/images/popcorn_after.png");
			$('.pop_point').val(5);
		});
	});  
</script>
