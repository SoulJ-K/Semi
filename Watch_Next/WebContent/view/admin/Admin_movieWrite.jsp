...
<form action="<%= request.getContextPath() %>/insert.movie" name="submitForm" method="post" encType="multipart/form-data">
	<div id="use_fix" style="width: 80%; margin:100px auto;">
		...
		<input type="file" id="admin_imageFile" name="admin_imageFile" onchange="LoadImg(this,this.value)">
			...
			<input type="checkbox" name="admin_movie_service" value="3"> 넷플릭스
			</div><br>
		...
		<div style="width: 100%; text-align:center;">
			<input type="submit" value="완료" id="admin_movie_submit" class="btn" onclick="return chk();" style="margin-left: 0px;">
			<input type="button" value="취소" id="admin_movie_cancel" class="btn" onclick="location.href='<%= request.getContextPath()%>/report.do'" style="margin-left: 0px;">
		</div>
	</div>
</form>
<!-- footer -->
