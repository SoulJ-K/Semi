...
<div id="sidebar">
	...
	<section>
		...
		<div class="p_slide-wrap">
			...
			<div class="p_slide-content">
				<ul id="p_slider1" class="p_slider">
					<% for(int i = 0; i < rlist.size(); i++) {%>
						<li class="p_item1">
							<div id="ranking" name="rank"><%= i + 1 %>위</div>
			...
			<hr class="md_line">
			<span class="rec_subtitle">최다 별점순</span>
			<div class="p_slide-content">
			...
			<hr class="md_line">
			<span class="rec_subtitle">최다 좋아요순</span>
			<div class="p_slide-content">
			...
			<script>
				...
				$(function(){
					for(var i = 0; i < rank.length; i++){
						if(document.getElementsByName("rank")[i].innerText=="1위"){
			       			document.getElementsByName("rank")[i].style.background="#ffd700";
						} else if(document.getElementsByName("rank")[i].innerText=="2위"){
			       			document.getElementsByName("rank")[i].style.background="#c0c0c0";
						} else if(document.getElementsByName("rank")[i].innerText=="3위"){
							document.getElementsByName("rank")[i].style.background="#8D4004";
						}	
					}
				});
			</script>
